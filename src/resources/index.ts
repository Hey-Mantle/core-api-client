...
export { EmailCampaignsResource } from './email-campaigns';
export { EmailDeliveriesResource } from './email-deliveries';
export { EmailLayoutsResource } from './email-layouts';
export { EmailSendersResource } from './email-senders';
...
export { NotificationPreferencesResource } from './notification-preferences';
