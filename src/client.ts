...
import { EmailLayoutsResource } from './resources/email-layouts';
import { EmailSendersResource } from './resources/email-senders';
...
export class MantleCoreClient {
  ...
  public readonly emailLayouts: EmailLayoutsResource;
  public readonly emailSenders: EmailSendersResource;
  ...
  constructor(config: MantleCoreClientConfig) {
    ...
    // Auth middleware — sets the Authorization header on every request
    this._api.use({
