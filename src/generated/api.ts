...
// Generated: 2026-05-03T12:59:29.531Z
...
export type paths = {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        /**
                         * @deprecated
                         * @description Deprecated. Use `PUT /docs/sites/{siteId}` on the repository's site. Writes continue to be mirrored onto the site during the rollout.
                         */
    ...
    "/docs/repositories/{id}/redirects": {
         ...
         * @deprecated
         * @description Deprecated. Redirects now live on `DocsSite`. Use `POST /docs/sites/{id}/redirects` instead.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/docs/sites/{id}/repositories": {
         ...
         * @description Update position and/or canonical (`isPrimary`) flag for existing attachments. Setting `isPrimary=true` on one attachment clears it on all other attachments of the same repo.
         */
        put: {
            parameters: {
                query?: never;
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description If true, makes this attachment canonical for the repo. Auto-true if the repo has no other attachments. */
                        isPrimary?: boolean;
                        repositoryId: string;
                    };
                };
         ...
         * @description If the detached attachment was the canonical one for the repo, the next attachment of that repo is automatically promoted.
         */
        delete: {
            parameters: {
                query?: never;
...
export type components = {
    schemas: {
        ...
        DocsSiteRepositoryAttachment: {
            ...
            createdAt?: string;
            id?: string;
            /** @description Whether this attachment is the canonical site for the repo */
            isPrimary?: boolean;
            position?: number;
         ...
         * @enum {string}
         */
        ThreadEventType: "contact_added" | "contact_removed" | "agent_assigned" | "team_assigned" | "inbox_assigned" | "customer_assigned" | "app_assigned" | "status_changed" | "priority_changed" | "channel_changed" | "loop_opened" | "loop_closed" | "loop_reopened" | "authenticated" | "unauthenticated" | "email_received" | "message" | "internal_note";
