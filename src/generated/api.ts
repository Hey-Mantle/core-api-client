...
// Generated: 2026-05-14T13:31:51.137Z
...
export type paths = {
        ...
        get: {
            parameters: {
                query?: {
                    ...
                    email?: string;
                    /** @description Comma-separated list of tags. Excludes affiliates that have any of these tags. */
                    excludeTags?: string;
                    ...
                    /** @description Comma-separated list of tags. Returns affiliates that have at least one of these tags. */
                    tags?: string;
                    /** @description The number of records to retrieve */
                    take?: components["parameters"]["take"];
                };
    ...
    "/affiliates/{id}/addTags": {
        ...
        put?: never;
        /**
         * Add tags to an affiliate
         * @description Add new tags to an affiliate by ID. Tags already on the affiliate are kept; duplicates are de-duplicated.
         */
        post: {
            parameters: {
                query?: never;
            ...
            responses: {
                /** @description The affiliate with the updated tags. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/affiliates/{id}/removeTags": {
        ...
        put?: never;
        /**
         * Remove tags from an affiliate
         * @description Remove the given tags from an affiliate by ID.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/apps/{appId}/plans/features": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description Required when type is "string". Array of allowed enum values. */
                        allowedValues?: string[];
                        /** @description The default value of the feature. For "string" features this must be one of allowedValues. */
                        defaultValue?: string;
                        ...
                        name?: string;
                        /**
                         * @description The type of the feature. Use "string" for multivariate (enum) features.
                         * @enum {string}
                         */
                        type?: "boolean" | "limit" | "limit_with_overage" | "string";
    ...
    "/attachments": {
         ...
         * @description Returns a short-lived presigned URL that the caller can `PUT` a file to,
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description MIME type of the file. Optional hint; the actual Content-Type is set by the client when PUTting to the signed URL. */
                        contentType?: string;
                        /** @description Original filename. Used to derive the storage key and is preserved as object metadata. */
                        filename: string;
                    };
                };
            };
            responses: {
                /** @description A presigned upload URL plus the download URL to reference once uploaded. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            /** @description Canonical download URL. Pass this as `attachments[].url` when creating a ticket message. */
                            downloadUrl: string;
                            /**
                             * Format: date-time
                             ...
                             */
                            expiresAt: string;
                            /** @description Storage object key (org-scoped). */
                            key: string;
                            /** @description Short-lived presigned URL. PUT the file binary here with the appropriate Content-Type header. */
                            signedUrl: string;
                        };
                    };
                };
                /** @description Invalid request (e.g., missing filename). */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/channels": {
        ...
        put?: never;
        /**
         * Create a read-only attribution channel
         * @description Creates a read-only channel used to attribute imported tickets to their
         *     original source. Useful when bringing historical tickets into Mantle
         *     for unified search and reporting.
         *
         *     Channels created here are attribution-only:
         *       - Replies must happen in the original system; the send path refuses
         *         public replies on these channels. Internal notes, status changes,
         *         and assignments still work.
         *       - The channel cannot be configured or edited from the helpdesk UI.
         *
         *     Repeated calls with the same `type` are idempotent — the existing
         *     channel is returned rather than a duplicate created.
         *
         *     To set up a fully-functional email or chat channel, use the helpdesk
         *     settings UI instead.
         */
        post: {
            parameters: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description Display name shown in the helpdesk UI */
                        name: string;
                        /**
            ...
            responses: {
                /** @description A channel of this type already exists and is returned unchanged. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description Read-only attribution channel created */
                201: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description The page number to retrieve */
                    page?: components["parameters"]["page"];
                    /** @description An optional list of plan ids to filter customers by. Returns only customers with an active subscription on any of the specified plans. Can be passed as a comma-separated string (planIds=uuid1,uuid2) or as an array (planIds=uuid1&planIds=uuid2). */
                    ...
                    /** @description The direction to sort by */
                    sortDirection?: components["parameters"]["sortDirection"];
                    /** @description The number of records to retrieve (max 100). */
                    take?: number;
                };
                header?: never;
                path?: never;
    ...
    "/customers/{id}/account_owners": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description Per-app commission overrides. When set, these rates apply instead of the customer-level commission for transactions from the specified app. */
                        appCommissions?: {
                            appId: string;
                            /** Format: date-time */
    ...
    "/customers/{id}/account_owners/{ownerId}": {
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description Per-app commission overrides. Pass the full list to replace existing overrides. Omit to leave unchanged. */
                        appCommissions?: {
                            appId: string;
                            /** Format: date-time */
                            commissionEndsAt?: string | null;
    ...
    "/devices": {
         ...
         * @description Idempotent on (userOrganization, expoPushToken). Re-registration on
         *     app launch bumps `lastSeenAt` and clears any prior disabled flag.
         */
        post: {
            parameters: {
                query?: never;
            ...
            responses: {
                ...
                401: components["responses"]["401"];
                /** @description Authenticated user is not a member of the active organization. */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/docs/repositories/{id}": {
         ...
         * @description Update settings on a documentation repository. A repository owns
        ...
        put: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        /** @description Whether new or updated content in the default locale is auto-translated to the specified locale. */
                        autoTranslate?: boolean;
                        /**
                         * @deprecated
                         * @description Set on the site via `PUT /docs/sites/{id}`.
                         */
                        ...
                        /** @description The locale to update auto-translate for (defaults to defaultLocale). */
                        locale?: string;
                        /**
                         * @deprecated
                         * @description Set on the site via `PUT /docs/sites/{id}` with `locale`.
                         */
    ...
    "/docs/repositories/{id}/redirects": {
         ...
         * @deprecated
         * @description Deprecated. Redirects now live on `DocsSite`. Use `GET /docs/sites/{id}/redirects` instead.
         */
        get: {
            parameters: {
                query?: never;
         ...
         * @deprecated
         * @description Use `POST /docs/sites/{id}/redirects` instead.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        /** @description Optional. Owning site for the redirects. Defaults to the site this repo's primary attachment points at. Useful when the repo is attached to multiple sites and the caller wants to specify which one. */
                        siteId?: string;
                        /**
                         * @description When true, the request fails if any submitted redirect collides with an existing one. When false (default), collisions are skipped and reported alongside the successfully-created rows.
                         * @default false
                         */
                        strict?: boolean;
                    };
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            redirects?: components["schemas"]["DocsRedirect"][];
                            /** @description Submitted redirects that collided with an existing row. Only present in non-strict mode. */
                            skipped?: {
                                fromPath?: string;
                                reason?: string;
                            }[];
                ...
                401: components["responses"]["401"];
                403: components["responses"]["403"];
                /** @description Repository or site not found */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description Duplicate redirects (strict mode only) */
                409: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/docs/repositories/{id}/redirects/{redirect_id}": {
         ...
         * Update a redirect
         * @deprecated
         * @description Deprecated. Redirects now live on `DocsSite`. Use `PUT /docs/sites/{id}/redirects/{redirect_id}` instead.
         */
        put: {
            parameters: {
                query?: never;
         ...
         * Delete a redirect
         * @deprecated
         * @description Deprecated. Redirects now live on `DocsSite`. Use `DELETE /docs/sites/{id}/redirects/{redirect_id}` instead.
         */
        delete: {
            parameters: {
                query?: never;
    ...
    "/docs/sites": {
         ...
         * @description Retrieve a list of documentation sites for the authenticated organization. Sites group one or more repositories behind a shared domain, theme, and redirects.
         */
        get: {
            parameters: {
                query?: {
                    /** @description Locale for localized title/shortDescription (defaults to the site default) */
                    locale?: string;
                };
                header?: never;
                path?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description List of documentation sites */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            sites?: components["schemas"]["DocsSite"][];
                        };
                    };
                };
                401: components["responses"]["401"];
         ...
         * @description Create a new documentation site and optionally attach existing repositories to it.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        /** @default en */
                        defaultLocale?: string;
                        /** @description Unique subdomain handle for the site */
                        handle: string;
                        /** @description Repository ids to attach to the new site */
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            site?: components["schemas"]["DocsSiteResponse"];
                        };
                    };
                };
                /** @description Validation error */
    ...
    "/docs/sites/{id}": {
        ...
        /**
         * Get a documentation site
         * @description Retrieve a single documentation site by ID. A repository ID in the URL will resolve to the owning site for backwards compatibility.
         */
        get: {
            parameters: {
                query?: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            site?: components["schemas"]["DocsSite"];
                        };
                    };
                };
                401: components["responses"]["401"];
         ...
         * @description Update site settings. Custom domain changes are blocked while the current domain is verified - disable it first, save, then re-enable with the new domain.
         */
        put: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        defaultLocale?: string;
                        handle?: string;
                        /** @description Required when writing title/shortDescription */
                        locale?: string;
                        /** @description Locale-scoped; requires `locale` in the body */
                        shortDescription?: string;
                        supportedLocales?: string[];
                        /** @description Locale-scoped; requires `locale` in the body */
                        title?: string;
         ...
         * @description Soft-delete a site. The handle is released for reuse.
         */
        delete: {
            parameters: {
                query?: never;
    ...
    "/docs/sites/{id}/redirects": {
        ...
        /** List redirects for a documentation site */
        get: {
            parameters: {
                query?: never;
                header?: never;
        ...
        put?: never;
        /** Create redirects for a documentation site */
        post: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        /** @description When true, return an error on any duplicate instead of skipping */
                        strict?: boolean;
                    };
                };
            };
            responses: {
                /** @description Redirects created; skipped entries are returned separately */
                201: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            /** @description Redirects newly inserted or restored from a soft-deleted state. */
                            created?: components["schemas"]["DocsRedirect"][];
                            /** @description Submitted redirects that collided with an existing live row. Only present in non-strict mode. */
                            skipped?: {
                                fromPath?: string;
                                reason?: string;
                            }[];
    ...
    "/docs/sites/{id}/redirects/{redirect_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put: {
            ...
            responses: {
                ...
                401: components["responses"]["401"];
                403: components["responses"]["403"];
                /** @description Site or redirect not found */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/docs/sites/{id}/repositories": {
        ...
        /** List repositories attached to a site */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            attachments?: components["schemas"]["DocsSiteRepositoryAttachment"][];
                        };
                    };
                };
                401: components["responses"]["401"];
        ...
        /**
         * Bulk update repository attachments
         * @description Update the position of existing attachments.
         */
        put: {
            parameters: {
                query?: never;
        ...
        post: {
            ...
            responses: {
                ...
                201: {
                    ...
                    content: {
                        "application/json": {
                            attachment?: components["schemas"]["DocsSiteRepositoryAttachment"];
                        };
                    };
                };
                /** @description Validation error */
                ...
                401: components["responses"]["401"];
                403: components["responses"]["403"];
                /** @description Site or repository not found */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        /** Detach a repository from a site */
        delete: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                401: components["responses"]["401"];
                403: components["responses"]["403"];
                /** @description Site or attachment not found */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        appId?: string;
                        /** @description Audience criteria object (e.g. { trigger, conditions }). Defaults to an empty object. */
    ...
    "/meetings/{id}/attendees/{attendeeId}": {
        ...
        put: {
            parameters: {
                query?: {
                    /** @description When "true", treat attendeeId as an external ID instead of a Mantle ID */
                    useExternalId?: "true";
                };
                header?: never;
                path: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        name?: string;
                        /** @description Link attendee to a Mantle user (null to unlink) */
                        userId?: string;
                    };
                };
            };
    ...
    "/notification_preferences": {
        ...
        /** Get the authenticated user's helpdesk notification preferences */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description Preference matrix + preferencesConfiguredAt timestamp. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        /**
         * Replace the authenticated user's helpdesk notification preferences
         * @description Atomic replace — every existing preference row for the user/org is
         *     deleted and replaced with the supplied set. Channels objects are
         *     normalized server-side (every channel key padded with false; pop
         *     requires inApp).
         */
        put: {
            parameters: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        helpDeskNotificationPreferences: {
        ...
        get: {
            parameters: {
                query?: {
                    ...
                    /** @description The maximum date/time (ISO 8601) of the last update to the Ticket */
                    maxUpdatedAt?: string;
                    /** @description The minimum date/time (ISO 8601) of the last update to the Ticket */
                    minUpdatedAt?: string;
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        assignedToId?: string;
                        /**
                         * @description The ID of the channel to attribute this ticket to. If omitted, the
    ...
    "/tickets/{id}/ai-replies": {
         ...
         * @description Runs the organization's Support Sidekick agent synchronously against the
        ...
        post: {
            ...
            requestBody?: {
                content: {
                    "application/json": {
                        /**
                         * @description Free-text direction for the agent (e.g., "make it more formal",
                         *     "apologise for the delay"). When provided without a `draft`, the
                         *     agent generates a fresh reply following the direction.
                         */
                        adjustment?: string;
                        /**
                         * @description The current draft reply. When provided with `adjustment` the agent
            ...
            responses: {
                /** @description A generated reply suggestion. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            aiReply: components["schemas"]["AiReply"];
                        };
                    };
                };
                /** @description Invalid request (bad parameter types or chat-disabled agent). */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                401: components["responses"]["401"];
                403: components["responses"]["403"];
                /** @description Ticket or Support Sidekick agent not found. */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description The agent run failed unexpectedly. */
                500: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/tickets/saved_filters": {
         ...
         * @description Get all saved ticket filter presets for the organization, ordered by displayOrder ascending then createdAt ascending. Saved ticket filters are organization-scoped — they are visible to every member of the organization regardless of which user created them.
         */
        get: {
            parameters: {
                query?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description A list of saved ticket filters. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            savedTicketFilters: components["schemas"]["SavedTicketFilter"][];
                        };
                    };
                };
                401: components["responses"]["401"];
        ...
        put?: never;
        /**
         * Create a saved ticket filter
         * @description Create a new saved ticket filter preset. The created filter is owned by the organization; if the OAuth session has an associated user, that user is recorded as the creator.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": {
                         ...
                         */
                        displayOrder?: number;
                        /** @description Filter selections to persist. Free-form JSON object — keys typically mirror the query parameters accepted by GET /tickets (status, priority, assignedToId, tags, customerId, channelId, search, etc.). */
                        filters?: {
                            [key: string]: unknown;
                        };
            ...
            responses: {
                /** @description The created saved ticket filter. */
                201: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            savedTicketFilter: components["schemas"]["SavedTicketFilter"];
                        };
                    };
                };
                /** @description Invalid request. */
    ...
    "/tickets/saved_filters/{filter_id}": {
        parameters: {
            query?: never;
            header?: never;
            path: {
                /** @description The ID of the saved ticket filter. */
                filter_id: string;
            };
            cookie?: never;
        };
        /** Get a saved ticket filter */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description The saved ticket filter. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        /**
         * Update a saved ticket filter
         * @description Partially update a saved ticket filter. Only the supplied fields are written.
         */
        put: {
            parameters: {
                query?: never;
            ...
            responses: {
                /** @description The updated saved ticket filter. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/tickets/saved_replies": {
        ...
        /**
         * List saved replies
         * @description List the organization's saved replies. Visibility rules are applied:
         *
         *     - **Public** (no `userId`, no `roles`): visible to every caller.
         *     - **Private** (`userId` set): visible only when the OAuth session is for that user.
         *     - **Role-restricted** (`roles` non-empty): visible only when the OAuth session's user roles intersect with the reply's roles.
         *
         *     Soft-deleted replies (`deletedAt` set) are excluded.
         */
        get: {
            parameters: {
                query?: {
                    /** @description Limit results to saved replies scoped to a specific app. */
                    appId?: string;
                    /** @description Limit results by workflow status. */
                    status?: "draft" | "active";
                };
                header?: never;
                path?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description A list of saved replies the caller can see. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            savedReplies: components["schemas"]["SavedReply"][];
                        };
                    };
                };
                401: components["responses"]["401"];
         ...
         * @description Create a new saved reply. The handle is derived from `title` if not supplied. Handles are unique per organization (excluding soft-deleted rows).
         *
         *     Visibility model:
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": {
                        appId?: string;
                        categoryId?: string;
                        /** @description Body of the saved reply, typically a TipTap JSON document. */
                        content?: {
                            [key: string]: unknown;
                        };
                        /** @default en */
                        defaultLocale?: string;
                        /** @description URL-safe handle. Defaults to a slugified `title`. */
                        handle?: string;
                        /** @description When true, the reply becomes private to the OAuth session's user. Mutually exclusive with `roles`. */
                        isPrivate?: boolean;
                        roles?: string[];
                        /**
                         * @default draft
            ...
            responses: {
                /** @description The created saved reply. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                    content: {
                        "application/json": {
                            savedReply: components["schemas"]["SavedReply"];
                        };
                    };
                };
                /** @description Invalid request. */
    ...
    "/tickets/saved_replies/{reply_id}": {
        parameters: {
            query?: never;
            header?: never;
            path: {
                /** @description The ID of the saved reply. */
                reply_id: string;
            };
            cookie?: never;
        };
        /**
         * Get a saved reply
         * @description Returns 404 when the reply does not exist, has been soft-deleted, or is not visible to the OAuth session per the visibility rules described on `GET /tickets/saved_replies`.
         */
        get: {
            parameters: {
                query?: never;
            ...
            responses: {
                ...
                401: components["responses"]["401"];
                403: components["responses"]["403"];
                /** @description Saved reply not found. */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
         ...
         * @description Partially update a saved reply. Only the fields supplied in the body are written.
         *
         *     Visibility:
        ...
        put: {
            ...
            responses: {
                /** @description The updated saved reply. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
         ...
         * @description Soft-deletes the saved reply (sets `deletedAt`) and tombstones the handle by suffixing it with `_deleted_<id>`, freeing the original handle for reuse.
         *
         *     Returns 404 when the reply does not exist, was already deleted, or is not visible to the OAuth session.
         */
        delete: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/json": {
                        ...
                        appInstallationId?: string;
                        /**
                         * @description Files to attach to the comment. Each entry must reference
                         *     a file previously uploaded via `POST /attachments` —
                         *     pass the returned `downloadUrl` as `url`. URLs that don't
                         *     originate from `POST /attachments` are rejected.
                         */
                        attachments?: {
                            ...
                            sizeBytes: number;
                            /** @description The `downloadUrl` returned by `POST /attachments`. */
                            url: string;
                        }[];
...
export type webhooks = {
    ...
    "helpdesk/thread_assigned": {
        ...
        post: {
            ...
            /** @description Helpdesk thread assigned to an agent */
            requestBody?: {
                content: {
...
export type components = {
    schemas: {
        ...
        Affiliate: {
            ...
            /** @description Tags applied to this affiliate */
            tags?: string[];
            /** Format: date-time */
            updatedAt: string;
        ...
        AiReply: {
            /** @description The generated reply content suggested for the ticket. */
            content: string;
        };
        App: {
        ...
        Customer: {
            ...
            /** @description An object of custom fields, keyed by the custom field name. */
            customFields?: Record<string, never>;
            /** @description Lightweight summaries of the customer's non-archived deals. Use the Deals endpoints for full details. */
            deals?: components["schemas"]["CustomerDeal"][];
            domain?: string;
            email?: string;
            /**
             * Format: date-time
        ...
        /** @description A lightweight deal summary embedded in customer responses. For full deal details, use the Deals endpoints. */
        CustomerDeal: {
            /** Format: float */
            amount?: number;
            amountCurrencyCode?: string;
        ...
        DocsRepository: {
            ...
            /** Format: date-time */
            updatedAt?: string;
            /** @description The public URL where this repository is hosted */
            url?: string;
            useCustomDomain?: boolean;
            /**
        ...
        /** @description A documentation site grouping one or more documentation repositories */
        DocsSite: {
            /** @description Site layout and theme configuration */
            config?: Record<string, never>;
            /** Format: date-time */
            createdAt?: string;
            customDomain?: string | null;
            ...
            repositories?: components["schemas"]["DocsSiteRepositoryAttachment"][];
            shortDescription?: string;
            supportedLocales?: string[];
            title?: string;
            /** Format: date-time */
            updatedAt?: string;
            /** @description The public URL where this site is hosted */
            url?: string;
            useCustomDomain?: boolean;
            /** @enum {string} */
            visibility?: "public" | "internal";
        ...
        /** @description A repository attached to a docs site */
        DocsSiteRepositoryAttachment: {
            /** Format: date-time */
            createdAt?: string;
            id?: string;
            position?: number;
            /** @description Minimal repository summary (only present when includeRepository=true) */
            repository?: {
                handle?: string;
                id?: string;
            };
        ...
        /** @description Response shape for site create/update operations */
        DocsSiteResponse: {
            config?: Record<string, never>;
            customDomain?: string | null;
            /** Format: date-time */
        ...
        Feature: {
            /** @description For "string" (multivariate) features, the list of allowed enum values. Null for other types. */
            ...
            name?: string;
            /**
             * @description The type of the feature. Use "string" for multivariate (enum) features whose values are drawn from a fixed list of allowed strings.
             * @enum {string}
             */
            type?: "boolean" | "limit" | "limit_with_overage" | "string";
            /**
        ...
        SavedReply: {
            /** @description The ID of the app this saved reply is scoped to, if any. */
            appId?: string | null;
            category?: components["schemas"]["SavedReplyCategory"];
            /** @description ID of the SavedReplyCategory grouping this reply, if any. */
            categoryId?: string | null;
            /** @description Body of the saved reply, typically a TipTap JSON document. Free-form JSON object. */
            content?: {
                [key: string]: unknown;
            };
            /** Format: date-time */
            createdAt: string;
            /** @description ISO language code for the saved reply's content (default `en`). */
            defaultLocale?: string;
            /** @description URL-safe handle for the saved reply, unique per organization. Auto-derived from `title` when not supplied. On delete the handle is suffixed with `_deleted_<id>` to free the slot. */
            handle: string;
            /** @description The unique identifier for the saved reply. */
            id: string;
            /** @description When non-empty, only users whose roles intersect with this list can read the reply. Mutually exclusive with `userId` (when both could be set, `userId` wins for visibility). */
            roles: string[];
            /**
             * @description Workflow status. `draft` replies are not surfaced in suggestion or quick-pick UIs.
             * @enum {string}
             */
            status: "draft" | "active";
            /** @description Free-form tags attached to the saved reply. */
            tags: string[];
            /** @description Display title of the saved reply. */
            title: string;
            /** Format: date-time */
            updatedAt: string;
            user?: components["schemas"]["SavedReplyUser"];
            /** @description When set, the reply is private to this user (only visible to them via the API). */
            userId?: string | null;
        };
        /** @description The category grouping this saved reply, when assigned. */
        SavedReplyCategory: {
            id?: string;
        ...
        /** @description The user the saved reply is private to, when applicable. */
        SavedReplyUser: {
            email?: string | null;
            id?: string;
            name?: string | null;
        ...
        SavedTicketFilter: {
            /**
             * Format: date-time
             * @description When the saved filter was created.
             */
            createdAt: string;
            /** @description Sort order used when rendering the list of saved filters. Lower values appear first. */
            displayOrder: number;
            /** @description The filter selections stored on this preset. Free-form JSON object whose shape is defined by the client (e.g. status, priority, assignedToId, tags, customerId, search, etc.). */
            filters: {
                [key: string]: unknown;
            };
            /** @description The unique identifier for the saved filter. */
            id: string;
            /** @description The display name of the saved filter. */
            name: string;
            /**
             * Format: date-time
             * @description When the saved filter was last updated.
             */
            updatedAt: string;
            /** @description The ID of the user who created the filter, if attributable. */
            userId?: string | null;
        };
        /**
         * @example {
         ...
         * @enum {string}
         */
        ThreadEventType: "contact_added" | "contact_removed" | "agent_assigned" | "team_assigned" | "inbox_assigned" | "customer_assigned" | "app_assigned" | "status_changed" | "priority_changed" | "channel_changed" | "loop_opened" | "loop_closed" | "loop_reopened" | "authenticated" | "unauthenticated" | "customer_auto_linked_unverified" | "locked" | "unlocked" | "auto_closed_from_resolved" | "locked_reply_dropped" | "locked_reply_forked_to_new_ticket" | "email_received" | "message" | "internal_note";
        ...
        Ticket: {
             ...
             */
            resolvedAt?: string;
            /** @description Polymorphic id companion to `sourceType` (e.g. Widget id for `widget`, IncomingEmail id for `incoming_email`, IncomingSlackMessage id for `incoming_slack_message`, CXAgent id for `cx_agent`, ApiClient id for `api_client`). May be `null` even when `sourceType` is set (e.g. the internal `/api/support` path uses `api_client` without an ApiClient id). */
            sourceId?: string | null;
            /**
             * @description Where this ticket originated. Polymorphic — see `sourceId` for the related entity id. Tickets created before this field was added have `null`.
             * @enum {string|null}
             */
            sourceType?: "widget" | "incoming_email" | "incoming_slack_message" | "cx_agent" | "api_client" | null;
            /**
